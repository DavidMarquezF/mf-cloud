...
# coap-gateway
FIRMWARE_COAP_UNSECURE_ADDRESS="0.0.0.0:$FIRMWARE_COAP_UNSECURE_PORT"
FIRMWARE_COAP_PORT=5682
FIRMWARE_COAP_ADDRESS="0.0.0.0:$FIRMWARE_COAP_PORT"
FIRMWARE_COAP_CLOUD_ID="00000000-0000-0000-0000-000000000001"
FIRMWARE_COAP_DISABLE_VERIFY_CLIENTS=true
FIRMWARE_COAP_DISABLE_BLOCKWISE_TRANSFER=false
FIRMWARE_COAP_BLOCKWISE_TRANSFER_SZX=1024
FIRMWARE_COAP_DISABLE_PEER_TCP_SIGNAL_MESSAGE_CSMS=false
...
go run main.go server.go config.go uri.go